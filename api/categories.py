    ...
    "5 Star": {
        "Less than 5 years": {
            "Less than 5 kg": [
                ...
                "Clean the washing machine drum monthly to prevent residue buildup.",
                "Use the appropriate amount of detergent to avoid excess foam.",
                "Run a maintenance wash with vinegar to eliminate odors.",
                "Regularly check the door seal for mold and clean it.",
                "Ensure the machine is level to avoid excessive vibration.",
                "Use the pre-wash setting for heavily soiled clothes.",
                "Clean the detergent drawer regularly.",
                "Avoid washing single heavy items to maintain balance."
            ],
            "5-7 kg": [
                ...
                "Inspect the door seal for mold and clean it.",
                "Run an empty hot wash periodically to clean the drum.",
                "Check and clean the pump filter every few months.",
                "Avoid overloading to prevent strain on the motor.",
                "Use high-efficiency detergent to reduce residue.",
            ...
            "More than 7 kg": [
                ...
                "Clean the drum monthly to prevent odor buildup.",
                "Use the correct amount of detergent to avoid residue.",
                "Run a hot water cycle with baking soda for freshness.",
                "Check the balance of the machine regularly.",
                "Keep the machine door slightly open to prevent mold.",
                "Inspect the water inlet filters for clogs.",
                "Avoid using too much fabric softener.",
                "Monitor and clean the lint filter regularly."
            ]
        },
        "5-10 years": {
            "Less than 5 kg": [
                ...
                "Run maintenance washes to keep the drum clean.",
                ...
                "Run an empty hot wash with vinegar to clean the interior.",
                "Monitor the machine for unusual noises."
            ],
            "5-7 kg": [
                ...
                "Run a hot water cycle with a machine cleaner.",
                "Check and clean the pump filter periodically.",
                "Avoid overloading the machine to extend its life.",
                "Inspect the door seal for mold and clean it.",
                "Ensure the machine is balanced to reduce noise."
            ],
            "More than 7 kg": [
                "Consider professional servicing for optimal performance.",
                "Evaluate the cost-effectiveness of replacing versus repairing.",
                "Run maintenance cycles to keep the drum clean.",
                "Inspect hoses for cracks and leaks.",
                "Use the appropriate amount of detergent.",
                "Clean the exterior of the machine regularly.",
                "Check the balance to avoid excessive vibration.",
                "Monitor the machine for unusual sounds.",
                "Inspect the water inlet filters for clogs.",
                "Run an empty wash with a cleaning solution to remove residue."
            ]
        },
        "More than 10 years": {
            "Less than 5 kg": [
                ...
                "Inspect hoses for signs of wear and replace if needed.",
                "Evaluate the machine's energy consumption.",
                "Run maintenance cycles to keep it clean.",
                "Check the door seal for mold and clean it.",
                "Use a washing machine cleaner periodically.",
                "Consider the cost of repairs versus replacement.",
                "Monitor the machine's performance closely."
            ],
            "5-7 kg": [
                ...
                "Monitor the machine for unusual noises.",
                "Inspect the water inlet filters for blockages.",
                "Ensure the machine is balanced to prevent vibration.",
                "Evaluate energy consumption to detect inefficiencies."
            ],
            "More than 7 kg": [
                "Monitor energy bills for signs of inefficiency.",
                "Consider the cost of continued use vs. replacement.",
                "Run hot water cycles to clean the drum.",
                "Inspect hoses and connections for leaks.",
                "Use the correct amount of detergent to avoid residue.",
                "Clean the exterior regularly.",
                "Check the door seal for mold and clean it.",
                "Run maintenance cycles with cleaning solutions.",
                "Monitor the machine's performance for issues.",
                "Inspect the pump filter periodically."
            ]
        }
    },
    "4 Star": {
        "Less than 5 years": {
            "Less than 5 kg": [
                ...
                "Run a maintenance wash with vinegar for freshness.",
                "Check the door seal for mold and clean it.",
                "Ensure the machine is level to reduce vibration.",
                "Clean the detergent drawer regularly.",
                "Avoid washing single heavy items to maintain balance.",
                "Use eco-friendly detergents for better impact."
            ],
            "5-7 kg": [
    ...
    "5 Star": {
        "Less than 5 years": {
            "Less than 200 liters": [
                ...
                "Avoid overloading the fridge to maintain efficiency.",
                "Check and replace door seals if they are worn out.",
                "Defrost the freezer regularly to avoid ice buildup.",
        ...
        "5-10 years": {
            "Less than 200 liters": [
                ...
                "Check the door seals for wear and replace if needed.",
                ...
                "Clean the interior and shelves regularly.",
        ...
        "More than 10 years": {
            "Less than 200 liters": [
                ...
                "Check for wear and tear on door seals.",
                "Inspect and clean the condenser coils regularly.",
                ...
                "Evaluate the overall performance and energy consumption."
            ],
            "200-300 liters": [
                "Consider upgrading to a more energy-efficient model.",
                "Check for wear and tear on door seals.",
    ...
    "5 Star": {
        "Less than 5 years": {
            "Less than 1 ton": [
                ...
                "Set the thermostat to a comfortable but efficient temperature.",
                ...
                "Utilize energy-saving mode if available.",
                "Ensure proper insulation in the room.",
                "Check for any air leaks and seal them.",
        ...
        "5-10 years": {
            "Less than 1 ton": [
                ...
                "Ensure the ductwork is sealed properly.",
        ...
        "More than 10 years": {
            "Less than 1 ton": [
                ...
                "Ensure the system is properly maintained.",
                "Check for leaks in ductwork.",
                "Monitor energy usage to detect inefficiencies.",
                "Have a professional assess the system's performance.",
                "Ensure the refrigerant is at the correct level.",
                "Replace outdated thermostats with smart ones.",
                "Improve home insulation.",
                "Consider zoned cooling for better efficiency.",
